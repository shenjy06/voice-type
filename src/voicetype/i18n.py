...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "settings.hotkey_toggle": "Enable Right Alt toggle (tap to start/stop recording)",
        "settings.hotkey_hint": "Quickly tap Right Alt to toggle recording.\nHolding Right Alt with another key will not trigger it.",
    ...
    "zh": {
        ...
        "settings.hotkey_toggle": "启用右 Alt 切换（点击开始/停止录制）",
        "settings.hotkey_hint": "快速点击右 Alt 来切换录制。\n按住右 Alt 加其他键不会触发。",
