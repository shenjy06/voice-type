...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "settings.hotkey_toggle": "Enable Left Alt toggle (tap to start/stop recording)",
        "settings.hotkey_hint": "Quickly tap Left Alt to toggle recording.\nHolding Alt + another key (e.g. Alt+Tab) will not trigger it.",
        "settings.hotkey_cancel": "<b>Alt+C</b> — Cancel recording and discard audio.",
        "settings.save": "Save",
    ...
    "zh": {
        ...
        "settings.hotkey_toggle": "启用左 Alt 切换（点击开始/停止录制）",
        "settings.hotkey_hint": "快速点击左 Alt 来切换录制。\n按住 Alt 加其他键（如 Alt+Tab）不会触发。",
        "settings.hotkey_cancel": "<b>Alt+C</b> — 取消录制并丢弃音频。",
        "settings.save": "保存",
        "settings.cancel": "取消",
