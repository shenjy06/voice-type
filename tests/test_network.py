...
class TestCheckNetworkAvailable:
    def test_network_available(self, mocker):
        ...
        mocker.patch("src.network.urllib.request.urlopen", return_value=mocker.MagicMock())
    ...
    def test_network_unavailable_os_error(self, mocker):
        ...
        mocker.patch(
            "src.network.urllib.request.urlopen",
    ...
    def test_custom_timeout(self, mocker):
        ...
        mock_urlopen = mocker.patch("src.network.urllib.request.urlopen")
